...
from sklearn.metrics import f1_score, classification_report, confusion_matrix# type: ignore

PROJECT_ROOT = Path(__file__).resolve().parent.parent

def test_et():
    # 1. Ayarlar
    MODEL_PATH = str(PROJECT_ROOT / "tavsiye_modeli_v4.joblib")
    CSV_PATH = str(PROJECT_ROOT / "StudentsPerformance_Extended.csv")
